...
<div class="row">
    ...
    <div class="col-md-2 col-sm-12 mb-1 mb-md-0">
        ...
        <?php echo Form::select('rombel', getNamaRombel(), request('rombel'), [
            'class' => 'form-select',
...
<?php /**PATH /Users/anurkholis/Sites/spp-zepi/resources/views/components/laporanform_tagihan.blade.php ENDPATH**/ ?>