...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="<?php echo e(asset('mentor')); ?>/assets/vendor/aos/aos.css" rel="stylesheet">
    ...
    <link href="<?php echo e(asset('mentor')); ?>/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href="<?php echo e(asset('mentor')); ?>/assets/css/style.css" rel="stylesheet">
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto">
                <img src="<?php echo e(\Storage::url(settings()->get('app_logo'))); ?>">
                <a href="#"><?php echo e(settings()->get('app_name')); ?></a>
            </h1>
    ...
    <section id="hero" class="d-flex justify-content-center align-items-center">
        <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
            <h1>Selamat Datang,<br>Di <?php echo e(settings()->get('app_name')); ?></h1>
            <h2>Kami menyediakan informasi seputar <?php echo e(settings()->get('app_name')); ?>

                <br> dan menyediakan sistem pembayaran spp
            </h2>
            <a href="<?php echo e(route('login')); ?>" class="btn-get-started">Login Pembayaran SPP</a>
        </div>
    </section><!-- End Hero -->
            ...
            <div class="container" data-aos="fade-up">
                <div class="row">
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                        <img src="<?php echo e(asset('mentor')); ?>/assets/img/bg2.jpg" class="img-fluid" alt="">
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-contact">
                        <h3><?php echo e(settings()->get('app_name')); ?></h3>
                        <p>
                            Jalan Pemandian<br>
                            Desa Mungkid<br>
                            Kecamatan Mungkid, Magelang <br><br>
                            <strong>Phone:</strong> <?php echo e(settings()->get('app_phone')); ?> atau
                            <?php echo e(settings()->get('no_wa_operator')); ?><br>
                            <strong>Email:</strong> <?php echo e(settings()->get('app_email')); ?><br>
                        </p>
                    </div>
    ...
    <!-- Vendor JS Files -->
    <script src="<?php echo e(asset('mentor')); ?>/assets/vendor/purecounter/purecounter_vanilla.js"></script>
    <script src="<?php echo e(asset('mentor')); ?>/assets/vendor/aos/aos.js"></script>
    <script src="<?php echo e(asset('niceadmin')); ?>/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo e(asset('mentor')); ?>/assets/vendor/swiper/swiper-bundle.min.js"></script>

    <!-- Template Main JS File -->
    <script src="<?php echo e(asset('mentor')); ?>/assets/js/main.js"></script>

</body>

</html>
<?php /**PATH /Users/anurkholis/Sites/spp-zepi/resources/views/welcome.blade.php ENDPATH**/ ?>