    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
                    ...
                    <table>
                        <tr>
                            <td
                                ...
                                Tahun Ajaran <?php echo e(getTahunAjaranFull(request('bulan'), request('tahun'))); ?>

                            </td>
                        </tr>
                        <tr>
                            <td style="padding:0px;">
                                Nama Siswa : <?php echo e($siswa->nama); ?> (<?php echo e($siswa->nisn); ?>)<br />
                                Kelas : <?php echo e($siswa->kelas); ?><br />
                                Jurusan : <?php echo e($siswa->jurusan); ?>
            ...
            <tr>
                <td></td>
                <td colspan="3">
                    Magelang, <?php echo e(now()->translatedFormat('d F Y')); ?> <br>
        ...
        <?php if(request('output') != 'pdf'): ?>
            <center style="margin-top: 20px;" class="tombol">
                <a class="btn btn-primary" href="<?php echo e(url()->full() . '&output=pdf'); ?>">Download PDF</a>
...
<?php /**PATH /Users/anurkholis/Sites/spp-zepi/resources/views/kartuspp_index.blade.php ENDPATH**/ ?>