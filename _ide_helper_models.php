 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\Spatie\Activitylog\Models\Activity[] $activities
 * @property-read int|null $activities_count
 * @property-read \Illuminate\Database\Eloquent\Collection|Biaya[] $children
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Biaya search($search, $threshold = null, $entireText = false, $entireTextOnly = false)
 * @method static \Illuminate\Database\Eloquent\Builder|Biaya searchRestricted($search, $restriction, $threshold = null, $entireText = false, $entireTextOnly = false)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Siswa whereKategori($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Siswa whereRombel($value)
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Database\Factories\WaliBankFactory factory(...$parameters)
